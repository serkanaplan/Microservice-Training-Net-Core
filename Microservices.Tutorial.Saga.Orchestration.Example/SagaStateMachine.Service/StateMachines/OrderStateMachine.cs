...
public class OrderStateMachine : MassTransitStateMachine<OrderStateInstance>
{
    ...
    public OrderStateMachine()
    {
        ...
        // tetikleyici event, state instance oluşturmak sadece tetikleyicinin sorumluluğundadır. diğer eventler oluşturulmuş bu state  instance üzerinde durum bilgisinin değişmesini sağlar
