...
public static class OrderOutboxSingletonDatabase
{
    ...
    static OrderOutboxSingletonDatabase() => _connection = new SqlConnection("Server=localhost, 1433;Database=OrderDB;User ID=SA;Password=Passw0rd;TrustServerCertificate=True");
