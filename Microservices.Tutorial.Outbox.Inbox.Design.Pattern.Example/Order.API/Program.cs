...
builder.Services.AddMassTransit(configurator =>
    configurator.UsingRabbitMq((context, _configure) => _configure.Host(builder.Configuration["RabbitMQ"])));
...
app.MapPost("/create-order", async (CreateOrderVM model, OrderDbContext orderDbContext, ISendEndpointProvider sendEndpointProvider) =>
{
    ...
    #region Outbox Pattern Olmaksızın!
    ...
    #endregion
    #region Outbox Pattern çalışması
